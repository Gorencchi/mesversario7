...
Garden.randomrgba = function (rmin, rmax, gmin, gmax, bmin, bmax, a) {
    ...
    // Variación suave
    var r = Math.max(0, Math.min(255, colorElegido.r + Math.round(Garden.random(-10, 10))));
    var g = Math.max(0, Math.min(255, colorElegido.g + Math.round(Garden.random(-10, 10))));
    var b = Math.max(0, Math.min(255, colorElegido.b + Math.round(Garden.random(-10, 10))));
